...
class binary_GA_uniform_CO:
    ...
    def parent_selection(self):
        ...
        for i in range(pop_size):
            ...
            # deterministic
            best_index = self.compare_2(self.population, index)
    ...
    def survivor_selection(self):
        ...
        for i in range(pop_size):
            ...
            # deterministic
            best_index = self.compare_2(competitor, index)
    ...
    def compare_2(self, population, index):
    ...
    def evolution(self, f):
        ...
        for i in range(termination):
            ...
            if (anytime_GA1[i] > self.local_min):
                anytime_GA1[i] = self.local_min

            # Update global minima if needed
